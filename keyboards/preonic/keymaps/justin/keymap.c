...
[_QWERTY] = LAYOUT_preonic_2x2u( \
  ...
  CUT,     PASTE,   OPT,     CMD,     LT(1, KC_BSPC),         SPC,         ENT,     MO(2),   LWORD,   RWORD  \
),
...
[_LOWER] = LAYOUT_preonic_2x2u( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, MDASH, \
...
[_RAISE] = LAYOUT_preonic_2x2u( \
  ...
  KC_CAPS,  KC_1,    KC_2,    KC_MS_UP, MWD, MWD,    KC_PGUP, KC_PGUP, KC_UP,    KC_9,    KC_0,    KC_PLUS,  \
  KC_DEL,  KC_F1,   KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,   KC_F5,   KC_F6,   KC_LEFT, KC_DOWN, KC_RIGHT, KC_RBRC, KC_BSLS, \
  _______, KC_F7,   KC_F8,   KC_F9,   MWU, MWU,  KC_PGDOWN, KC_PGDOWN, KC_NUBS, KC_PGUP, KC_PGDN, _______, \
   _______, _______, _______, KC_MS_BTN2, KC_MS_BTN1, KC_ENTER, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),
